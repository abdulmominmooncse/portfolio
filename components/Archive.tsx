  ...
  return (
    <div className="max-w-[1140px] mx-auto px-4 py-24">
      <div className="w-full flex flex-col items-center">
        <h2 className="text-3xl font-['Inter',sans-serif] font-semibold">
          Other Noteworthy Projects
        </h2>
        <p className="text-sm font-['Inter',sans-serif] text-[#64ffda]">
          view the archive
        </p>
      </div>
      ...
      <div className="mt-12 flex items-center justify-center">
        {showMore ? (
          <button
            ...
            className="w-36 h-12 rounded-md text-[#64ffda] text-[13px] border border-text-[#64ffda] hover:bg-[rgba(100,255,218,0.1)] duration-300"
          >
            Show Less
          </button>
        ) : (
