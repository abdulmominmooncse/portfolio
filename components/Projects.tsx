...
const Projects = () => {
  return (
    <section id="project" className="max-w-[1440px] mx-auto lg:px-20 py-24">
          ...
          >
            <div>
              <Image
                ...
                alt="amazonImg"
              />
              <div className="absolute w-full h-full bg-text-[#64ffda]/10 rounded-lg top-0 left-0 group-hover:bg-transparent duration-300"></div>
            </div>
          </a>
          <div className="w-full xl:w-1/2 flex flex-col gap-6 lg:justify-between items-end text-right xl:-ml-16 z-10">
            <div>
              <p className="font-titleFont text-text-[#64ffda] text-sm tracking-wide">
                Featured Project
              </p>
            ...
            <p className="bg-[#112240] text-sm md:text-base p-2 md:p-6 rounded-md">
              ...
              <span className="text-text-[#64ffda]">O-auth</span> and then make
              the purchage using{" "}
              <span className="text-text-[#64ffda]">stripe</span>.
            </p>
            ...
            <div className="text-2xl flex gap-4">
              <a
                className="hover:text-text-[#64ffda] duration-300"
        ...
        <div className="flex flex-col xl:flex-row-reverse gap-6">
          ...
          <div className="w-full xl:w-1/2 flex flex-col gap-6 justify-between items-end text-right z-10">
            ...
            <p className="text-sm md:text-base bg-[#112240] p-2 md:p-6 rounded-md xl:-mr-16">
              ...
              latest post and{" "}
              <span className="text-text-[#64ffda]">comments on</span> it by
              passing your ideas besides you can try to add your own{" "}
              <span className="text-text-[#64ffda]">post</span> on it by logging
              on the portal.
            </p>
            <ul className="text-xs md:text-sm font-titleFont tracking-wide flex gap-2 md:gap-5 justify-between text-textDark">
              <li>Nextjs</li>
